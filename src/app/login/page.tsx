  ...
  return (
    <div className="flex-1 flex flex-col w-full px-8 sm:max-w-md justify-center gap-2 mt-20 mx-auto min-h-[70vh]">
      ...
      <div className="flex flex-col space-y-2 text-center mb-8">
        ...
        <h1 className="text-3xl font-extrabold tracking-tighter sm:text-4xl text-gray-900">Welcome Back</h1>
        <p className="text-gray-500 text-sm max-w-sm mx-auto">
          Enter your email and password to access your account or create a new one.
        </p>
      </div>
      ...
      <form className="flex-1 flex flex-col w-full justify-center gap-5 text-gray-800 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="flex flex-col gap-3 mt-4">
          ...
          <Link
            href="/signup"
            className="inline-flex items-center justify-center rounded-lg text-sm font-bold shadow-sm transition-all focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-offset-2 border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 h-11 px-4 py-2"
          >
            Create an Account
          </Link>
        </div>
